...
class Keychain:
    ...
    def __init__(self, user: str = "user-bluepool-1.8", testing: bool = False):
    ...
    def _get_service(self):
        ...
        """
        if self.testing:
            return f"bluepool-{self.user}-test"
        else:
            return f"bluepool-{self.user}"
    ...
    def add_username(self, user_name: str):
        keyring.set_password("bluepool", "user_name", user_name)

    def get_username(self):
        return keyring.get_password("bluepool", "user_name")

    def add_password(self, password: str):
        keyring.set_password("bluepool", "password", password)

    def get_password(self):
        return keyring.get_password("bluepool", "password")
