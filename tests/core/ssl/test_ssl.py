...
class TestSSL:
    ...
    async def test_farmer(self, harvester_farmer):
        ...
        ssl_context = ssl_context_for_client(
            farmer_server.ca_private_crt_path,
            farmer_server.ca_private_crt_path,
            priv_crt,
            priv_key,
        )
        ...
        generate_ca_signed_cert(
            farmer_server.chia_ca_crt_path.read_bytes(),
            farmer_server.chia_ca_key_path.read_bytes(),
            pub_crt,
            pub_key,
        )
        ssl_context = ssl_context_for_client(
            farmer_server.chia_ca_crt_path,
            farmer_server.chia_ca_crt_path,
            pub_crt,
            pub_key,
        )
    ...
    async def test_full_node(self, wallet_node):
        ...
        ssl_context = ssl_context_for_client(
            full_node_server.chia_ca_crt_path,
            full_node_server.chia_ca_crt_path,
            pub_crt,
            pub_key,
        )
    ...
    async def test_wallet(self, wallet_node):
        ...
        generate_ca_signed_cert(
            wallet_server.chia_ca_crt_path.read_bytes(),
        ...
        ssl_context = ssl_context_for_client(
            wallet_server.ca_private_crt_path,
            wallet_server.ca_private_crt_path,
            priv_crt,
            priv_key,
        )
    ...
    async def test_harvester(self, harvester_farmer):
        ...
        ssl_context = ssl_context_for_client(
            harvester_server.chia_ca_crt_path,
            harvester_server.chia_ca_crt_path,
            pub_crt,
            pub_key,
        )
    ...
    async def test_timelord(self, timelord):
        ...
        ssl_context = ssl_context_for_client(
            timelord_server.chia_ca_crt_path,
            timelord_server.chia_ca_crt_path,
            pub_crt,
            pub_key,
        )
