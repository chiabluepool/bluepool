...
class TestFullNodeProtocol:
    ...
    async def test_basic_chain(self, wallet_nodes):
        ...
        await time_out_assert(
            10,
            time_out_messages(incoming_queue, "request_mempool_transactions", expected_requests),
        )
        ...
        for i in range(5):
            ...
            for _ in range(100):
                ...
                output = ConditionWithArgs(
                    ...
                    [receiver_puzzlehash, int_to_bytes(10000000)],
                )
    ...
    async def test_new_signage_point_caching(self, wallet_nodes, empty_blockchain):
        ...
        await full_node_1.respond_signage_point(
            fnp.RespondSignagePoint(4, sp.cc_vdf, sp.cc_proof, sp.rc_vdf, sp.rc_proof),
            peer,
        )
